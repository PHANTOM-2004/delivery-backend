...
func (p *kMerchantServiceClient) MerchantRegister(ctx context.Context, Req *merchant.MerchantRegisterReq, callOptions ...callopt.Option) (r *merchant.MerchantRegisterResp, err error) {
