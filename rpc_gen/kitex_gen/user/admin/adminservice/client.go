...
func (p *kAdminServiceClient) AdminRegister(ctx context.Context, Req *admin.AdminRegisterReq, callOptions ...callopt.Option) (r *admin.AdminRegisterResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.AdminRegister(ctx, Req)
}

func (p *kAdminServiceClient) AdminLogin(ctx context.Context, Req *admin.AdminLoginReq, callOptions ...callopt.Option) (r *admin.AdminLoginResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
